...
// assets
import { IconLogout, IconUser, IconSettingsAutomation, IconLock } from '@tabler/icons';
import { logout } from 'store/auth/login.action';
                                    ...
                                    <PerfectScrollbar style={{ height: '100%', maxHeight: 'calc(100vh - 250px)', overflowX: 'hidden' }}>
                                        <Box sx={{ p: 2 }}>
                                            ...
                                            >
                                                ...
                                                >
                                                    <ListItemIcon>
                                                        <IconSettingsAutomation stroke={1.5} size="1.3rem" />
                                                    </ListItemIcon>
